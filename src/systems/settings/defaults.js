...
export function registerDefaults() {
  ...
  registerSetting({ key: 'ip_security_enabled',           category: 'system',  type: 'bool',   defaultValue: true,                          description: 'Verify each MC join against the player\'s approved IP list. New IPs get blocked until the user approves via DM.' });
